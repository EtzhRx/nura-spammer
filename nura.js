...
client.on("message", async message => {
  ...
  if (command === "spam") {
    ...
    var maxMessages = 100000000000000000000000000; // Change based on how many messages you want sent
    ...
    function sendSpamMessage() {
      try {
        ...
        message.channel.send("`Ini Spam Text ke` ***#" + count + "***");
